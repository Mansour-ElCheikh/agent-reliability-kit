...
status: active
name: scaffold
description: Bootstrap or adopt the agent-reliability-scaffold into a project. Detects mode + installed tools, runs every applicable emitter, seeds team-shared files, and offers to set the governance ratchet baseline. Use to install the scaffold for the first time or to re-emit after canonical/ changes.
purpose: |
...
reads:
  ...
  - the scaffold's canonical/ specs
...
trigger_phrases:
  ...
  - "install the reliability scaffold"
  - "adopt the scaffold"
  - "re-emit the configs"
---
...
Install or refresh the agent-reliability-scaffold in a project with one command.
...
- First-time install of the scaffold into a project
...
- To run a one-off governance audit, call the engine directly (`scaffold-engine audit`)
