...
3. `dev/epics/{epic}/adr.md` — decisions and approaches tried during build
...
- [ ] `adr.md` has at least one entry per component built — if empty, this is a **finding** (build skipped decision logging)
