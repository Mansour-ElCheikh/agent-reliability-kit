...
**Consumed by:** the `session-harvest` skill (reads it if the project emits one)
...
- `canonical/skills/session-harvest.md` — the sole consumer in v0.1
