...
```markdown
- [User prefers concise answers with explicit trade-offs](user_role.md) — skip preamble; lead with the rule
- [Validated: worked examples over prose specs](feedback_examples.md) — keep reference snippets runnable
```
...
---
name: User role
description: User prefers concise answers with explicit trade-offs
type: user
---
