...
const SEED_FILES: Array<[string, string]> = [
  ...
  ['conventions/git-workflow.md', 'conventions/git-workflow.md'],
  ['conventions/sandbox.md', 'conventions/sandbox.md'],
...
async function main(): Promise<number> {
  ...
  program
    .name('scaffold')
    .description('Bootstrap or adopt the agent-reliability-scaffold into a project')
