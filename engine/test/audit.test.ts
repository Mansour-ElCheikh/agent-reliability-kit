...
describe('predicate registry', () => {
  it('lists the 13 built-in predicates (6 v0.1 + 3 ADR-0007 universal + 2 ADR-0010 Min-Invariant + 1 ADR-0016 integration-layer + 1 ADR-0026 test-existence)', () => {
...
describe('ADR-0007 — profile + Universal Default Set (hard acceptance)', () => {
  ...
  it('doc_validity: missing frontmatter warn under solo, error under team', async () => {
    ...
    // must stay open under the real clock (ADR-0025 expiry); a wide window keeps
